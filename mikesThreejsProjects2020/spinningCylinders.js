...
function randomCylinder(args) {
    ...
    const maxHeight = 'maxHeight' in args ? args.maxHeight : 3.0;
...
function createRotatingCylinders(n, args) {
    ...
    const minRate = 'minRate' in args ? args.minRate : 2.0
    const maxRate = 'maxRate' in args ? args.maxRate : 20.0
...
function createScene() {
    let n = 800;
    let args = {minRate: 4, maxRate: 10.2, minOffset: 0.5, maxOffset: 20.0, minRad: 0.2, yjiggle: 15.6};
